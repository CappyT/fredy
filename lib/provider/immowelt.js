...
/**
 * Enrich the description, building facts and publication date from the exposé.
 * The pipeline keeps this request behind the `provider_details` opt-in.
 *
...
async function fetchDetails(listing, browser) {
  try {
    ...
    return {
      ...
      publishedAt: publicationDate(classified?.metadata?.creationDate) ?? listing.publishedAt,
    };
  } catch (error) {
