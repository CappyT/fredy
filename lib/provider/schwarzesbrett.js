...
import { localPublicationDate } from '../utils/publicationDate.js';
...
async function fetchDetails(listing, browser) {
  ...
  try {
    ...
    return {
      ...
      publishedAt: localPublicationDate(readIconValue($, 'fa-calendar'), 'Europe/Berlin') ?? listing.publishedAt,
...
function normalize(o, runUrl) {
  ...
  return {
    ...
    publishedAt: localPublicationDate(o.published, 'Europe/Berlin'),
  };
}
...
const config = {
  ...
  crawlFields: {
    ...
    published: '.fa-calendar + span | trim',
  },
  fetchDetails,
  normalize,
