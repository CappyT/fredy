 ...
 * @param {any} [browser] The shared browser used for website fallback.
 * @returns {Promise<any[]>}
 */
 ...
 * Madrid to Italy's coverage registers, which read the address as Italian, spend one of fibermap's
 * five requests an hour on it and stamp the listing "nothing here" for six months.
 *
