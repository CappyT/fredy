 ...
 * cards. It goes through the shared browser: the page sits behind DataDome, which answers a plain
 * request with a 403 interstitial, and the browser is the only client here that holds the cookie
 * that wall wants.
 *
