...
import { relativePublicationDate } from '../utils/publicationDate.js';
...
function normalize(o) {
  ...
  return {
    ...
    // The portal exposes the last update age rather than the original publication date.
    publishedAt: relativePublicationDate(o.updated?.replace(/^Aktualisiert:\s*/i, ''), 'Europe/Berlin'),
  };
}
...
const config = {
  ...
  crawlFields: {
    ...
    updated: '.aktualisierung | removeNewline | trim',
  },
  normalize: normalize,
