...
import { recordPriceChange, notifyPriceChanges, getThresholdPercent } from './services/listings/priceHistoryService.js';
...
import { sleep, mapLimit } from './utils.js';
...
class FredyPipelineExecutioner {
  ...
  async _findNew(listings) {
    ...
    for (const listing of candidates) {
      ...
      const change = recordPriceChange({ ...stored, ...shown }, listing.price, {
        source: 'scrape',
        thresholdPercent,
        newHash: listing.id,
      });
