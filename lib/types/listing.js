 ...
 * @property {string} [currency] ISO 4217 code the price is written in, set by the pipeline from the
 *   country of the listing (`CHF` for Switzerland, `EUR` otherwise). Absent on a listing stored before
 *   currencies existed, which reads as euros. See `lib/utils/currency.js`.
