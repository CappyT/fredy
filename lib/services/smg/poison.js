 ...
 * @param {Object} input.query the request's query as it was sent, plus the `sortBy` and
 *   `sortDirection` the request carries beside it
 ...
 * @param {Object} input.query the request's query and its sort, for the detector
