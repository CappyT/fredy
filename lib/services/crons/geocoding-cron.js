...
/**
 * Run the geocoding sweep now, then every six hours.
 *
 * Awaited on start, unlike the sweeps that talk to a portal: this one asks Nominatim, one address
 * a second, only for the rows a scrape could not place, and an instance that has caught up does
 * nothing at all here.
 *
