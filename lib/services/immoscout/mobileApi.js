...
import { publicationDate, relativePublicationDate } from '../../utils/publicationDate.js';
  ...
  return responseBody.resultListItems
    ...
    .map((expose) => {
      ...
      return {
        ...
        image,
        // Vienna keeps Berlin's offset, so one zone reads both national sites.
        publishedAt: relativePublicationDate(item.published, 'Europe/Berlin', fetchedAt),
      };
    });
}
