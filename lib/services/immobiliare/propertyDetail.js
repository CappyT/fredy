 ...
 * advert whole, and that answer carries both. It sits behind nothing, and it is asked in the app's
 * voice, which is why it is also what the description backfill sweeps against instead of a rendered
 * page.
 */
