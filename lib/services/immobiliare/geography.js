...
/**
 * The host the android app talks to, unrelated to www.immobiliare.it. This geography endpoint is not
 * behind DataDome; the search endpoint on the same host is - see `./appApi.js`.
 */
