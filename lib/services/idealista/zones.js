 ...
 * the repository (15s at the coverage registers, 20s at fibermap): a bare `fetch` has no timeout of
 * its own, and a host that accepts the connection and then says nothing would hold a job run open
