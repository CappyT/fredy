 ...
 * to the Italian coverage registers - which parse the address as Italian, spend a throttled request
 * on it and stamp the listing "nothing here" for the next six months.
 *
