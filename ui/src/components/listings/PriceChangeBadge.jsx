 ...
 */
export default function PriceChangeBadge({ price, previousPrice, changedAt, currency = null }) {
  ...
  const tooltip = [
    t('listings.priceChangeFrom', { price: formatPrice(previous, locale, currency) }),
