...
import { Checkbox, Input, InputNumber, Select } from '@douyinfe/semi-ui-19';
  ...
  return (
    <div className="settingsShell__page">
      ...
      >
        ...
        <AdminField label={t('settings.dateFormat')} help={t('settings.dateFormatHelp')} htmlFor="dateFormat">
          <Select id="dateFormat" value={form.dateFormat} onChange={(value) => setField('dateFormat', value)}>
